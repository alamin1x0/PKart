...
import com.developeralamin.pkart.databinding.ItemCategoryProductLayoutBinding
...
class CategoryProductAdapter(val context: Context, val list: ArrayList<AddProductModel>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryProductViewHolder {
        val binding = ItemCategoryProductLayoutBinding.inflate(LayoutInflater.from(parent.context),
            parent,
            false)
